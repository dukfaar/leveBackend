...
type Service interface {
	...
	FindByXivdbID(string) (*Model, error)
...
func (s *MgoService) Create(model *Model) (*Model, error) {
	...
	if err == nil {
		s.eventbus.Emit("leve.created", model)
	}
...
func (s *MgoService) Update(id string, input interface{}) (*Model, error) {
	...
	s.eventbus.Emit("leve.updated", result)
...
func (s *MgoService) DeleteByID(id string) (string, error) {
	...
	if err == nil {
		s.eventbus.Emit("leve.deleted", id)
	}
...
func (s *MgoService) FindByXivdbID(id string) (*Model, error) {
	var result *Model
